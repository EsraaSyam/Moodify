...
const register_request_1 = require("./request/register.request");
const user_response_1 = require("./response/user.response");
const login_request_1 = require("./request/login.request");
...
let AuthController = class AuthController {
    ...
    async registerUser(data, res) {
        ...
        return res.status(201).json({
            ...
            data: new user_response_1.UserResponse(user),
        });
    }
